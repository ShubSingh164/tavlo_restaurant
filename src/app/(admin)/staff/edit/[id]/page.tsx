...
/**
 * Tavlo Restaurant ERP - Edit Staff Page
 * 
 * Edit existing staff member details with:
...
export default function EditStaffPage() {
        ...
        const loadStaffData = () => {
            ...
            if (staff) {
                ...
                setFormData({
                    ...
                    salary: '',
                    employmentType: 'full-time',
                    preferredShift: staff.shift?.replace(' Shift', '').toLowerCase() || 'morning',
                    workingDays: ['monday', 'tuesday', 'wednesday', 'thursday', 'friday'],
                    emergencyContactName: '',
                    emergencyContactPhone: '',
                    emergencyContactRelation: '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Update staff data (in real app, would call API)
    ...
    return (
            ...
            <div className={styles.addStaffPage}>
                ...
                <div className={styles.formContainer}>
                    ...
                    {/* Form */}
                    <form id="editStaffForm" className={styles.form} onSubmit={handleSubmit}>
                        <div className={styles.formContent}>
                            ...
                            <div className={styles.photoSection}>
                                <div className={styles.photoUpload}>
                                    {formData.photo ? (
                                        <div className={styles.photoPreview}>
                                            <img src={formData.photo} alt={staffName} />
                                ...
                                <h2 className={styles.staffNameTitle}>{staffName}</h2>
                                <span className={`${styles.statusBadge} ${styles[formData.status]}`}>
                                    {formData.status === 'on-duty' ? '🟢 On Duty' :
                                        formData.status === 'on-break' ? '🟡 On Break' : '⚫ Off Duty'}
                                </span>
                            </div>
